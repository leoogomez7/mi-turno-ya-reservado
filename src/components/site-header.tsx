  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="relative mx-auto flex w-full max-w-6xl flex-wrap items-center justify-between gap-2 px-4 py-3 md:px-6">
        ...
        {open && (
          <div className="absolute right-4 top-full z-50 mt-2 w-[calc(100vw-2rem)] max-w-xs rounded-3xl border border-border/60 bg-background/95 p-3 shadow-2xl backdrop-blur-xl md:hidden">
